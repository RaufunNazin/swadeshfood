  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-y-8 lg:gap-y-16 px-2 lg:px-48 bg-accent py-8 lg:py-16">
        <div className="flex flex-wrap justify-evenly lg:justify-between items-start gap-4">
          <div className="flex flex-col gap-y-5 justify-center">
            ...
            <div className="flex justify-center items-center gap-x-3 lg:gap-x-6">
              <a href="https://www.facebook.com/snapgenix" target="_blank">
                <button>
                  <LiaFacebook className="text-[16px] lg:text-[30px] text-xdark hover:text-brand transition-all duration-150" />
                </button>
              </a>
              <a
              ...
              >
                <button>
                  <IoLogoWhatsapp className="text-[14px] lg:text-[24px] text-xdark hover:text-brand transition-all duration-150" />
                </button>
              </a>
              <a href="https://www.youtube.com/@SnapGenix" target="_blank">
                <button>
                  <AiOutlineYoutube className="text-[17px] lg:text-[32px] text-xdark hover:text-brand transition-all duration-150" />
                </button>
              </a>
            </div>
          </div>
          <div className="lg:flex grid grid-cols-2 lg:flex-col gap-4 items-start">
            <button
              onClick={() => navigate("/store")}
              className="text-[12px] lg:text-[16px] text-start font-light text-xdark hover:text-brand transition-all duration-150"
            >
              Store
            </button>
            <button
          ...
          <div className="flex flex-col gap-y-4 pl-[34px] w-full lg:w-fit items-start lg:items-start">
          ...
          <div className="flex flex-col gap-y-4 pl-[34px] w-full lg:w-fit items-start lg:items-start">
            <Tooltip title="Click to view" color={"#026839"} key={"location"}>
              <a
                ...
                target="_blank"
                className="text-[12px] lg:text-[16px] font-light text-xdark w-full text-start lg:text-left lg:w-fit"
              >
