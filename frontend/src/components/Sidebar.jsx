    ...
    <>
      ...
      >
        <Menu
          ...
          customCrossIcon={
            <div className="bg-neutral-100 dark:bg-neutral-700 p-1 rounded-full text-neutral-500 dark:text-neutral-300 hover:bg-red-50 hover:text-red-500 transition-all">
              <RiCloseLine size={24} />
            </div>
          }
          width={"85%"}
        ...
        >
            ...
            {isLoggedIn ? (
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  <p className="font-bold text-neutral-900 dark:text-white text-lg truncate">
                    {user.username}
                  </p>
                ...
                <RiArrowRightSLine className="text-neutral-400" />
              </div>
            ) : (
          ...
          {/* --- Menu Links --- */}
          <div className="flex flex-col px-4 gap-1 pb-4 bg-white dark:bg-neutral-900">
            {user?.role === 1 && (
              <NavItem
        ...
        >
          <p>
            {t("sign_out_confirmation") || "Are you sure you want to sign out?"}
          </p>
        </Modal>
      </ConfigProvider>
    </>
    ...
    className={`flex items-center gap-4 w-full p-3.5 rounded-xl transition-all font-medium text-base
        ${
          highlight
            ...
            : "text-neutral-600 dark:text-neutral-300 hover:bg-green-50 dark:hover:bg-neutral-800 hover:text-green-700 dark:hover:text-green-400"
        }`}
  >
    <Icon
      className={`text-xl ${highlight ? "text-white" : "text-neutral-400 dark:text-neutral-500 group-hover:text-green-600"}`}
    />
    <span>{label}</span>
  </button>
);
