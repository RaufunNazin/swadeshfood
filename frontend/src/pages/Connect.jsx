...
const Connect = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
      ...
      {/* --- Header Section --- */}
      <div className="bg-white dark:bg-gray-800 py-16 md:py-24 text-center px-4 relative overflow-hidden transition-colors duration-300">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight relative z-10">
          {t("connect_title_1") || "Rooted in "}{" "}
          <span className="text-brand dark:text-green-400">
            {t("connect_title_2") || "Trust"}
          </span>
        </h1>
        <p className="text-gray-500 dark:text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed relative z-10">
          {t("connect_subtitle") ||
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed text-justify">
              ...
              <strong className="dark:text-white">Swadesh Food</strong>{" "}
              {t("mission_p1_end") ||
          ...
          <div className="order-1 md:order-2 h-[400px] bg-gray-200 dark:bg-gray-800 rounded-3xl overflow-hidden shadow-lg relative group">
            <img
              src="/farm.jpeg"
              alt="Our Farm"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teamMembers.map((member, idx) => (
              <div
                key={idx}
                className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all hover:-translate-y-1 text-center group"
              >
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-gray-50 dark:border-gray-700 group-hover:border-green-100 dark:group-hover:border-green-900 transition-colors">
                  <img
                    src={member.image}
                    alt={member.name}
          ...
          <div className="relative border-l-2 border-gray-200 dark:border-gray-700 ml-4 space-y-12">
            {timelineEvents.map((event, index) => (
              <div key={index} className="relative pl-10">
                <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-brand dark:bg-green-500 border-4 border-white dark:border-gray-800 shadow-sm"></div>
        ...
        <div className="grid md:grid-cols-3 gap-6 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-3xl p-8 md:p-12 border border-transparent dark:border-gray-700">
          <div className="flex flex-col items-center text-center p-4">
            <MdOutlinePhoneInTalk className="text-3xl mb-4 text-green-600 dark:text-green-400" />
            <h3 className="font-bold text-lg mb-1">
              {t("call_us") || "Call Us"}
            </h3>
            <p className="text-gray-600 dark:text-gray-400">+880 1700-663922</p>
          </div>
          <div className="flex flex-col items-center text-center p-4 border-t md:border-t-0 md:border-l border-gray-200 dark:border-gray-700">
