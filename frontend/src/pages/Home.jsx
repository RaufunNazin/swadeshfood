  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
      ...
      <div className="relative h-[450px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gray-900/80 dark:bg-black/80 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12">
            {categories.map((category) => (
              ...
              >
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-gray-800 dark:to-gray-700 flex items-center justify-center shadow-sm group-hover:shadow-lg group-hover:shadow-emerald-100 dark:group-hover:shadow-gray-900 transition-all duration-300 group-hover:scale-110 relative overflow-hidden ring-4 ring-transparent group-hover:ring-emerald-50 dark:group-hover:ring-gray-700">
                ...
                <span className="font-medium text-gray-600 dark:text-gray-300 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 text-lg transition-colors">
                  {category.name}
                </span>
              </button>
            ))}
      ...
      {/* --- WEEKLY HARVEST --- */}
      <section className="py-24 bg-gray-50/50 dark:bg-gray-800/30 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-14">
            ...
            <button
              onClick={() => navigate("/store")}
              className="hidden md:flex items-center gap-2 text-gray-500 dark:text-gray-400 font-semibold hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors group"
            >
              {t("view_all") || "View All"}{" "}
      ...
      {/* --- NEW ARRIVALS --- */}
      <section className="py-24 relative overflow-hidden bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-900 dark:to-gray-800 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-16 text-center">
            <button
              ...
              className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-black dark:hover:bg-gray-200 px-10 py-4 rounded-full font-bold transition-all shadow-xl hover:shadow-2xl hover:scale-105"
            >
      ...
      {/* --- TRUST BANNER --- */}
      <section className="py-24 bg-stone-50 dark:bg-gray-900 relative overflow-hidden transition-colors">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-gray-800 dark:text-gray-100 leading-tight">
