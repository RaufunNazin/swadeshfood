...
const InputField = ({
  ...
  <div className="relative">
    ...
    <input
      type={type}
      className="w-full pl-10 pr-4 py-3 rounded-xl border border-neutral-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all bg-neutral-50 focus:bg-white"
...
const Checkout = () => {
  ...
  return (
    ...
    >
      <div className="bg-neutral-50 min-h-screen font-sans text-neutral-800 flex flex-col">
        <Notification />
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-neutral-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-neutral-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all bg-neutral-50 focus:bg-white h-24 resize-none"
                  ...
                  <textarea
                    className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all bg-neutral-50 focus:bg-white h-20 resize-none"
            ...
            <div className="lg:pl-8">
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-neutral-100 sticky top-24">
                ...
                <div className="border-t border-neutral-100 pt-4 space-y-3">
                  ...
                  <div className="flex justify-between text-xl font-bold text-neutral-900 pt-2 border-t border-neutral-100 mt-2">
                    <span>Total</span>
        ...
        >
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-neutral-300 focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none"
              value={loginEmail}
